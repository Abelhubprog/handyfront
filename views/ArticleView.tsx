...
export const ArticleView = () => {
    ...
    return (
        <div className="max-w-3xl mx-auto px-6 py-12">
            <Button variant="ghost" onClick={() => navigate('/blog')} className="mb-8 pl-0 hover:bg-transparent hover:text-blue-600">
                <ArrowRight className="rotate-180 mr-2" size={16} /> Back to Blog
            </Button>
